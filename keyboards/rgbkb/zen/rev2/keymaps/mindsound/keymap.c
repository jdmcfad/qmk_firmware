...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_MPLY,   KC_DEL,  KC_LGUI, KC_LALT, LOWER, HYPR_SPC,KC_BSPC,KC_ENT,   KC_SPACE, RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,\
                                                 HYPR_SPC,KC_BSPC,KC_ENT,   KC_SPACE \
  ),
  ...
  [_LOWER] = LAYOUT( \
    ...
    _______, _______, RGB_TOG, _______, _______, _______, RGB_SPD, RGB_SPI, _______, _______, _______, KC_HOME, KC_END,  _______, \
