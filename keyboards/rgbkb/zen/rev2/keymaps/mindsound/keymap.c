...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_MPLY,   KC_DEL,  KC_LGUI, KC_LALT, LOWER, KC_SPC,  KC_LCBR, KC_RCBR,  KC_SPACE, RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,\
                                                 KC_SPC,  KC_LCBR, KC_RCBR,  KC_SPACE \
  ),
  ...
  [_LOWER] = LAYOUT( \
    ...
    _______, RGB_HUD, RGB_VAD, RGB_HUI, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_END,  _______, \
    _______, _______, _______, _______, _______, _______, KC_LPRN, KC_RPRN, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, \
  ...
  [_RAISE] = LAYOUT( \
    ...
    _______, RGB_SAI, RGB_VAI, RGB_SAD, _______, _______,                   _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
    _______, RGB_HUD, RGB_VAD, RGB_HUI, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_PGDN, _______, \
    _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, \
